        ...
        <Card.Body>
          ...
          <Form onSubmit={handleSubmit}>
            <Form.Group className="mb-3">
              ...
              <Form.Control className="add-form-input" type="text" value={name} onChange={(e) => setName(e.target.value)} required />
            </Form.Group>

            <Form.Group className="mb-3">
              <Form.Label>Descripción</Form.Label>
              <Form.Control as="textarea" rows={4} className="add-form-input" value={description} onChange={(e) => setDescription(e.target.value)} />
            </Form.Group>
            ...
            <div className="d-flex gap-2 justify-content-center mt-4">
              <Button className="add-form-btn" type="submit">Guardar</Button>
              <Button className="add-form-btn-secondary" onClick={() => navigate(-1)}>Cancelar</Button>
            </div>
          </Form>
        </Card.Body>
      </Card>
